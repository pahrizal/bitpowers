...
mkdir -p src test docs/bitpowers/plans

# Create a simple implementation plan
cat > docs/bitpowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/bitpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/bitpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"bitpowers:subagent-driven-development"' "$SESSION_FILE"; then
