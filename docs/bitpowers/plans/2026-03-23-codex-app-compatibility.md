...
**Spec:** `docs/bitpowers/specs/2026-03-23-codex-app-compatibility-design.md`
...
| `skills/using-bitpowers/references/codex-tools.md` | Codex platform reference | Add detection + finishing docs |
...
To:
```
- **bitpowers:using-git-worktrees** - REQUIRED: Ensures isolated workspace (creates one or verifies existing)
```
...
**Files:**
- Modify: `skills/using-bitpowers/references/codex-tools.md:25` (append at end)

- [ ] **Step 1: Read the current file**

Read `skills/using-bitpowers/references/codex-tools.md` in full. Confirm it ends at line 25-26 after the multi_agent section.
...
```bash
git add skills/using-bitpowers/references/codex-tools.md
...
- `skills/using-bitpowers/references/codex-tools.md` — two new sections at end
