...
> **For agentic workers:** REQUIRED: Use bitpowers:subagent-driven-development (if subagents available) or bitpowers:executing-plans to implement this plan.
...
**Spec:** docs/bitpowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/bitpowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use bitpowers:subagent-driven-development (if subagents available) or bitpowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
