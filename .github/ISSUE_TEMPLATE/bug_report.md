...
## Is this a Bitpowers issue or a platform issue?
<!-- Bitpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Bitpowers installed.

     If the problem persists without Bitpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Bitpowers installed
