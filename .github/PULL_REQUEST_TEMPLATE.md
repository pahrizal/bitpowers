...
<!-- Bitpowers core contains general-purpose skills and infrastructure
...
<!-- If this PR adds support for a new harness (IDE, CLI tool, agent
     ...
     A real integration loads the `using-bitpowers` bootstrap at session
...
- [ ] If this is a skills change: I used `bitpowers:writing-skills` and
